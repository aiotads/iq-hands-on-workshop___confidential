...
Welcome to the ** Hands-On Workshop Prep Site**. This is a self-contained, browser-native platform designed for workshop participants to sync their environments, follow hardware flashing guides, and access event handouts. 

**No repository cloning or code downloading is required for users.** Participants simply open this web platform in their browser to get everything ready before and during the live sessions.
...
* **Prerequisite Fast-Track:** Direct entry to software checklists and device flashing steps.
* **Interactive Agenda:** Features a complete timeline of the workshop day.
* **Event Details:** Displays real-time information regarding event dates, times, and physical venue locations.
...
### 3. [Windows Flashing Guidel Guide](https://aiotads.github.io/iq-hands-on-workshop___confidential/flashing.html)
...
### 4. [FAQ Knowledge Base](https://aiotads.github.io/iq-hands-on-workshop___confidential/faq.html)
An instant client-side troubleshooting interface equipped with a top global search bar.
* **Comprehensive Error Tracking:** Covers common setup errors regarding `adb` environmental paths, driver issues, MobaXterm (UART) serial port identification, and Ubuntu/Linux flashing permission anomalies.
<img width="1344" height="769" alt="faq_preview" src="https://github.com/user-attachments/assets/182e0658-dea6-44af-b18e-cf980c334bb7" />
...
* **Hardware Verification:** A clean grid checklist for attendees to confirm their kit components.
* **GitHub Project Portals:** Built-in redirection tiles to the official open-source ecosystems: **iQ-Studio** and **iQ-Foundry**.
...
2. **Verify the Toolchain:** Navigate to **Pre-Install** and ensure all items on the *Everything at a Glance* table are checked.
3. **Flash Your Device:** Follow the graphics under the **Flashing** tab chronologically when prompted by the instructor.
4. **Self-Troubleshoot:** Use the global `Search software / error...` input field at the top header to instantly filter the **FAQ** page for any runtime blocks.
